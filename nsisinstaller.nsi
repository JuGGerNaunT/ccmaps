...
Section "RA2/YR Maps Renderer" Section1
	...
	SetOutPath "$INSTDIR\"
	File "build\msvc10\bin\Release\CNCMaps_GUI.exe"
	File "..\branches\CNCMaps.NET\CNCMaps\bin/Release\CNCMaps.exe"
	File "..\branches\CNCMaps.NET\CNCMaps\bin/Release\OpenTK.dll"
...
Section Uninstall
	...
	Delete "$SMPROGRAMS\CNC Maps Renderer\RA2/YR Maps renderer.lnk"
